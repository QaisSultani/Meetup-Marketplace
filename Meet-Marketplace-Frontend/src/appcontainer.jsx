...
import reviewMentor from "./client/components/patients/reviewMentee/index.jsx";
import AppUniversal from "./admin/app-universal";

import PublicProfile from "./client/components/doctors/publicprofile/index.jsx";
          ...
          <div>
            ...
            <Switch>
              ...
              <Route
                path="/login"
                exact
                component={!isMenteeLoggedIn ? LoginContainer : Home2}
              />
              <Route
                path="/register"
                exact
                component={!isMenteeLoggedIn ? Register : Home2}
              />
              <Route
              ...
              <Route
                ...
                exact
                component={!isMenteeLoggedIn ? ForgotPassword : Home2}
              />
              ...
              <Route
                path="/doctor/profile/:mentorSlug"
              ...
              {isMenteeLoggedIn && (
                <>
                  ...
                  />
                  <Route
                    path="/patient/reviewMentor"
                    exact
                    component={reviewMentor}
                  />
                  <Route
                  ...
                  />
                  <Route path="/booking/:email" exact component={Booking} />
